...
intrinsics = {
    '(640, 480)': {
        ...
        'dist_coefs': [
            [6.15935887e+00, 6.35386798e+04, 1.45303461e-01, -7.91757365e-01, 2.13849355e+04]
        ],
        'resolution': [640, 480]
    },
    'version': 1
...
msgpack_file = Path("/Users/nimeshnagururu/Documents/tb_skills_analysis/world.intrinsics")
